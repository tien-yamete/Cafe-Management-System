...
public class EditStaff extends javax.swing.JDialog {
    ...
    public EditStaff(java.awt.Frame parent, boolean modal, ModelStaff modelUser) {
        super(parent, modal);
        initComponents();
        ...
        taiKhoanText.setText(modelUser.getUsername());
        matKhauText.setText(modelUser.getPassword());
        emailText.setText(modelUser.getEmail());
        if(modelUser.getPosition().equals("admin")){
            viTriComboBox.setSelectedIndex(0);
        }
        else 
            viTriComboBox.setSelectedIndex(1);
    ...
    private void initComponents() {
        ...
        taiKhoanText.setBackground(new java.awt.Color(204, 204, 204));
        ...
        matKhauText.setBackground(new java.awt.Color(204, 204, 204));
