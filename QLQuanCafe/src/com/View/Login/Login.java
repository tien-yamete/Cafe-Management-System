...
import Com.Lmao.Controller.UserDAO;
...
public class Login extends javax.swing.JFrame {
    ...
    private void LoginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_LoginButtonActionPerformed
        boolean kt = false;
        for(ModelStaff m : udao.getListUser()){
            if(UserNameTextField.getText().equalsIgnoreCase(m.getUsername()) && UserPasswordField.getText().equalsIgnoreCase(m.getPassword())){
                ...
                Dashboard dasdboard = new Dashboard();
                dasdboard.setVisible(true);
                dasdboard.pack();
                dasdboard.setLocationRelativeTo(null); // Frame Center
                this.dispose();                
                kt = true;
            }   
        }
